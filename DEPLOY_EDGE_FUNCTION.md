...
# 또는 특정 프로젝트에 직접 배포
supabase functions deploy approve-payment --project-ref your_project_ref
```
...
2. **Edge Functions 메뉴 이동**
   ...
   - 또는 URL: https://supabase.com/dashboard/project/{your_project_ref}/functions
...
```bash
# Secret 추가
supabase secrets set TOSS_SECRET_KEY=your_toss_secret_key --project-ref your_project_ref
